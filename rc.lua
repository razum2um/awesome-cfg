...
beautiful.init("/home/razum2um/.config/awesome/themes/zenburn.lua")
...
-- terminal = "urxvtc"
terminal = "urxvt -fn xft:Terminus:pixelsize=14 -tr -tint black -depth 32 -fg grey90 -bg grey10"
...
globalkeys = awful.util.table.join(
    ...
    -- Scratchpad
    awful.key({ modkey }, s, function () scratch.drop("urxvt -tr -tint grey -sh 50", "center", "right", 0.40, 1.0) end),
    -- end mine
...
run_once("kbdd")
run_once("xxkb")
run_once("screen -x || screen -d -m", nil, "SCREEN -d -m")
run_once("parcellite")
run_once("xscreensaver")
--run_once("skype", nil, "./skype")
--run_once("psi-plus")
--run_once("google-chrome")
--run_once("firefox-bin", nil, "/opt/firefox/firefox-bin")
run_once("urxvtd", "-q -o -f", "urxvtd -q -o -f")
